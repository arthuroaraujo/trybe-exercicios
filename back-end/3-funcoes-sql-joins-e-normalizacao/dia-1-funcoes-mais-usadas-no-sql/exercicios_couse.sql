...
SELECT MAX(salary) - MIN(salary) AS diferenca_salarios
FROM employees;

SELECT job_id, AVG(salary) AS salario_medio
FROM employees
GROUP BY job_id
ORDER BY salario_medio DESC;

SELECT SUM(salary) FROM employees AS soma_dos_salarios;
...
SELECT job_id , AVG(salary) AS avg_salary,  COUNT(*) AS number_of_employees
FROM employees
